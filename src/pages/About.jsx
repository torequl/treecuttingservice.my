...
export default function About() {
  return (
    <>
      <Seo
        title="About Us | TreeCare KL & Selangor"
        description="Learn about TreeCare, a local tree cutting and property care company serving homeowners and businesses in KL & Selangor with safe, professional tree services."
      />

      <section className="page-hero">
        <div className="container">
          <div className="breadcrumbs"><Link to="/">Home</Link> / About</div>
          <h1>Professional Tree Care Across KL &amp; Selangor</h1>
          <p className="lead">We help homeowners, property managers and businesses across KL &amp; Selangor take care of their trees and land — safely, professionally and without the stress.</p>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container split">
          <Reveal className="img-frame">
            <img
              src={aboutImage}
              alt="TreeCare team assessing a tree on a residential property in KL & Selangor"
              loading="lazy"
              width="800"
              height="680"
            />
